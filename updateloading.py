...
import os
import winsound
winsound.PlaySound(r'Data\pysound\loading.wav',winsound.SND_ALIAS | winsound.SND_ASYNC)
def showProgress():
                global val
                while val<100:
                        val+=15
